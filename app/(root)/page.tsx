        ...
        <div className='interviews-section'>
          {
            hasPastInterviews ? (
              userInterviews?.map((interview) => (
                <InterviewCard {...interview} key={interview.id} currentUserId={user?.id} section="taken" />
              ))
            ) : (
        ...
        <div className='interviews-section'>
          {
            hasAvailableInterviews ? (
              availableInterviews?.map((interview) => (
                <InterviewCard {...interview} key={interview.id} currentUserId={user?.id} section="available" />
              ))
            ) : (
